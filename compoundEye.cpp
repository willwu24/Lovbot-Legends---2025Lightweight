...
int eyeNum = 18;
//int eyePortThres[14] = {39,78,117,155,194,233,272,312,350,390,429,468,580,619}; // 14 eyes
...
int eyePortThres0[18] = {31,62,93,124,156,187,218,253,283,315,345,378,408,441,471,499,531,562}; //18 circular eyes 335-->338, 562-->545
//                       0,20,40, 60, 80,100,120,140,160,180,200,220,240,260,280,300,320,340

//int eyePortThres1[18] = {35,64,94,124,155,187,214,247,276,308,336,365,420,450,483,512,542,562}; //18 circular eyes 335-->338, 562-->545
//                       0,20,40, 60, 80,100,120,140,160,180,200,220,240,260,280,300,320,340

int eyePortThres1[18] = {31,61,90,119,149,179,208,240,270,298,329,359,385,415,446,473,500,530}; //18 circular eyes 335-->338, 562-->545
//                       0, 20,40, 60, 80,100,120,140,160,180,200,220,240,260,280,300,320,340
...
void eyeSetup(){
  // if(getBotNum()==0){
  //   for(int i = 0; i<18; i++){
  //     eyePortThres[i]=eyePortThres0[i];
  //   }
  //   // eyePortThres[18] = {31,62,93,124,156,187,218,253,283,315,345,378,408,441,471,499,531,562};
  // }
  // else{
  //   for(int i = 0; i<18; i++){
  //     eyePortThres[i]=eyePortThres1[i];
  //   }
  // }
